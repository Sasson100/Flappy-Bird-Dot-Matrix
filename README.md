...
4. terminal_version.py: A version of it I made when I didn't have the components on me that prints the matrix to the terminal and uses input
5. button.py: A library for the button module, with irq and debounce embedded in it.
6. flappy_bird.py: The main file for the code
7. Some photos related to the fact that this is a school assignment.
